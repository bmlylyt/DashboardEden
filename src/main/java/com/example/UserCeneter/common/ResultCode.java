package com.example.UserCeneter.common;
...
public enum ResultCode implements Serializable {
    ...
    INVALID_REGISTER_PARAMETER(10006, "Invalid register parameter"),
    ...
    REGISTER_CODE_IS_EMPTY(-20004, "No captcha code is found"),
